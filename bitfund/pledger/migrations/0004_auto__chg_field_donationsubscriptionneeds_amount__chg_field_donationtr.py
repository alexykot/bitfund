...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DonationSubscriptionNeeds.amount'
        db.alter_column('pledger_donationsubscriptionneeds', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'DonationTransaction.transaction_hash'
        db.alter_column('pledger_donationtransaction', 'transaction_hash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))
        # Deleting field 'DonationSubscription.datetime_last_sent'
        db.delete_column('pledger_donationsubscription', 'datetime_last_sent')

        # Adding field 'DonationSubscription.datetime_added'
        db.add_column('pledger_donationsubscription', 'datetime_added',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 7, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DonationSubscriptionNeeds.amount'
        db.alter_column('pledger_donationsubscriptionneeds', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'DonationTransaction.transaction_hash'
        db.alter_column('pledger_donationtransaction', 'transaction_hash', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True))
        # Adding field 'DonationSubscription.datetime_last_sent'
        db.add_column('pledger_donationsubscription', 'datetime_last_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'DonationSubscription.datetime_added'
        db.delete_column('pledger_donationsubscription', 'datetime_added')
    ...
    models = {
        ...
        'pledger.donationcart': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 7, 0, 0)'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'project.projectgoal': {
            ...
            'date_starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'project.projectneed': {
            ...
            'date_starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 7, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
