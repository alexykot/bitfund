...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DonationSubscription.active'
        db.delete_column('pledger_donationsubscription', 'active')

        # Adding field 'DonationSubscription.is_active'
        db.add_column('pledger_donationsubscription', 'is_active',
    ...
    def backwards(self, orm):
        # Adding field 'DonationSubscription.active'
        db.add_column('pledger_donationsubscription', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'DonationSubscription.is_active'
        db.delete_column('pledger_donationsubscription', 'is_active')
    ...
    models = {
        ...
        'pledger.donationsubscription': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'project.project': {
            ...
            'status_in_project': ('django.db.models.fields.CharField', [], {'default': "'sole_developer'", 'max_length': '80', 'null': 'True', 'blank': 'True'}),
