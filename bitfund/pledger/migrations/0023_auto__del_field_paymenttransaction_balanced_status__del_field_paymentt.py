...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentTransaction.mango_card'
        db.add_column('pledger_paymenttransaction', 'mango_card',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pledger.MangoBankCard'], on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'PaymentTransaction.is_completed'
        db.add_column('pledger_paymenttransaction', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PaymentTransaction.is_successful'
        db.add_column('pledger_paymenttransaction', 'is_successful',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PaymentTransaction.mango_tag'
        db.add_column('pledger_paymenttransaction', 'mango_tag',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PaymentTransaction.mango_card'
        db.delete_column('pledger_paymenttransaction', 'mango_card_id')

        # Deleting field 'PaymentTransaction.is_completed'
        db.delete_column('pledger_paymenttransaction', 'is_completed')

        # Deleting field 'PaymentTransaction.is_successful'
        db.delete_column('pledger_paymenttransaction', 'is_successful')

        # Deleting field 'PaymentTransaction.mango_tag'
        db.delete_column('pledger_paymenttransaction', 'mango_tag')
    ...
    models = {
        ...
        'pledger.paymenttransaction': {
            ...
            'mango_account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pledger.MangoAccount']", 'on_delete': 'models.PROTECT'}),
            'mango_card': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pledger.MangoBankCard']", 'on_delete': 'models.PROTECT'}),
            'mango_contribution_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'mango_tag': ('django.db.models.fields.CharField', [], {'max_length': '22', 'null': 'True', 'blank': 'True'}),
