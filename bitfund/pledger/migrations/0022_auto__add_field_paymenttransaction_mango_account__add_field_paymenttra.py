...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentTransaction.mango_account'
        db.add_column('pledger_paymenttransaction', 'mango_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pledger.MangoAccount'], on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'PaymentTransaction.mango_contribution_id'
        db.add_column('pledger_paymenttransaction', 'mango_contribution_id',
    ...
    def backwards(self, orm):
        # Deleting field 'PaymentTransaction.mango_account'
        db.delete_column('pledger_paymenttransaction', 'mango_account_id')

        # Deleting field 'PaymentTransaction.mango_contribution_id'
        db.delete_column('pledger_paymenttransaction', 'mango_contribution_id')
