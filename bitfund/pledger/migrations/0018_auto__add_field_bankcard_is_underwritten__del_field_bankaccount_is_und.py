...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BankAccount.is_underwritten'
        db.delete_column('pledger_bankaccount', 'is_underwritten')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BankAccount.is_underwritten'
        db.add_column('pledger_bankaccount', 'is_underwritten',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
