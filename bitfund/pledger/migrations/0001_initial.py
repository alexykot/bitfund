...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pledger_profile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='my_profile', unique=True, primary_key=True, to=orm['auth.User'])),
            ...
            ('status_in_project', self.gf('django.db.models.fields.CharField')(default='sole_developer', max_length=80)),
        ))
        ...
        db.create_table('pledger_donationcart', (
            ...
            ('datetime_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 21, 0, 0))),
        ))
