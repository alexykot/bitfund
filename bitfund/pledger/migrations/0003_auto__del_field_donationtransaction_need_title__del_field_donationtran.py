...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DonationTransaction.need_title'
        db.delete_column('pledger_donationtransaction', 'need_title')

        # Deleting field 'DonationTransaction.datetime_added'
        db.delete_column('pledger_donationtransaction', 'datetime_added')

        # Deleting field 'DonationTransaction.goal_datetime_ending'
        db.delete_column('pledger_donationtransaction', 'goal_datetime_ending')

        # Deleting field 'DonationTransaction.need'
        db.delete_column('pledger_donationtransaction', 'need_id')

        # Deleting field 'DonationTransaction.goal_key'
        db.delete_column('pledger_donationtransaction', 'goal_key')

        # Deleting field 'DonationTransaction.goal'
        db.delete_column('pledger_donationtransaction', 'goal_id')

        # Deleting field 'DonationTransaction.goal_title'
        db.delete_column('pledger_donationtransaction', 'goal_title')

        # Deleting field 'DonationTransaction.need_key'
        db.delete_column('pledger_donationtransaction', 'need_key')

        # Adding field 'DonationTransaction.transaction_datetime'
        db.add_column('pledger_donationtransaction', 'transaction_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 21, 0, 0)),
                      keep_default=False)

        # Adding field 'DonationTransaction.accepting_need'
        db.add_column('pledger_donationtransaction', 'accepting_need',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.ProjectNeed'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.accepting_need_title'
        db.add_column('pledger_donationtransaction', 'accepting_need_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.accepting_need_key'
        db.add_column('pledger_donationtransaction', 'accepting_need_key',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.accepting_goal'
        db.add_column('pledger_donationtransaction', 'accepting_goal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.ProjectGoal'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.accepting_goal_title'
        db.add_column('pledger_donationtransaction', 'accepting_goal_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.accepting_goal_key'
        db.add_column('pledger_donationtransaction', 'accepting_goal_key',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.accepting_goal_datetime_ending'
        db.add_column('pledger_donationtransaction', 'accepting_goal_datetime_ending',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DonationTransaction.need_title'
        db.add_column('pledger_donationtransaction', 'need_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'DonationTransaction.datetime_added'
        raise RuntimeError("Cannot reverse this migration. 'DonationTransaction.datetime_added' and its values cannot be restored.")
        # Adding field 'DonationTransaction.goal_datetime_ending'
        db.add_column('pledger_donationtransaction', 'goal_datetime_ending',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.need'
        db.add_column('pledger_donationtransaction', 'need',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.ProjectNeed'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.goal_key'
        db.add_column('pledger_donationtransaction', 'goal_key',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.goal'
        db.add_column('pledger_donationtransaction', 'goal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.ProjectGoal'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.goal_title'
        db.add_column('pledger_donationtransaction', 'goal_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DonationTransaction.need_key'
        db.add_column('pledger_donationtransaction', 'need_key',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DonationTransaction.transaction_datetime'
        db.delete_column('pledger_donationtransaction', 'transaction_datetime')

        # Deleting field 'DonationTransaction.accepting_need'
        db.delete_column('pledger_donationtransaction', 'accepting_need_id')

        # Deleting field 'DonationTransaction.accepting_need_title'
        db.delete_column('pledger_donationtransaction', 'accepting_need_title')

        # Deleting field 'DonationTransaction.accepting_need_key'
        db.delete_column('pledger_donationtransaction', 'accepting_need_key')

        # Deleting field 'DonationTransaction.accepting_goal'
        db.delete_column('pledger_donationtransaction', 'accepting_goal_id')

        # Deleting field 'DonationTransaction.accepting_goal_title'
        db.delete_column('pledger_donationtransaction', 'accepting_goal_title')

        # Deleting field 'DonationTransaction.accepting_goal_key'
        db.delete_column('pledger_donationtransaction', 'accepting_goal_key')

        # Deleting field 'DonationTransaction.accepting_goal_datetime_ending'
        db.delete_column('pledger_donationtransaction', 'accepting_goal_datetime_ending')
    ...
    models = {
        ...
        'pledger.donationtransaction': {
            ...
            'transaction_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 0)'}),
