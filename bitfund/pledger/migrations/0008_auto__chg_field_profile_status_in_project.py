...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pledger_profile', 'status_in_project', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.status_in_project'
        db.alter_column('pledger_profile', 'status_in_project', self.gf('django.db.models.fields.CharField')(max_length=80))
