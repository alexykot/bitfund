...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BankCard.is_underwritten'
        db.delete_column('pledger_bankcard', 'is_underwritten')

        # Adding field 'BalancedAccount.is_underwritten'
        db.add_column('pledger_balancedaccount', 'is_underwritten',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BankCard.is_underwritten'
        db.add_column('pledger_bankcard', 'is_underwritten',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'BalancedAccount.is_underwritten'
        db.delete_column('pledger_balancedaccount', 'is_underwritten')
    ...
    models = {
        ...
        'pledger.balancedaccount': {
            'Meta': {'object_name': 'BalancedAccount'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_underwritten': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'uri': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'})
        },
        'pledger.bankaccount': {
            'Meta': {'object_name': 'BankAccount'},
            'balanced_account': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['pledger.BalancedAccount']", 'unique': 'True'}),
        ...
        'pledger.bankcard': {
            ...
            'name_on_card': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'pledger.donationsubscription': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'project.projectneed': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 13, 0, 0)'}),
            'date_ending': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
