...
urlpatterns += patterns('bitfund.project.views',
    ...
    (r'^projects/(?P<project_key>[a-z]{1}[a-z0-9-_.]{1,})/chart/(?P<size>medium|small|large)/{0,}$', 'chart_image_project'),
    (r'^projects/(?P<project_key>[a-z]{1}[a-z0-9-_.]{1,})/need/(?P<need_key>[a-z]{1}[a-z0-9-_.]{1,})/chart/{0,}$', 'chart_image_need'),
    ...
    (r'^projects/(?P<project_key>[a-z]{1}[a-z0-9-_.]{1,})/edit_goals/(?P<goal_key>[a-z]{1}[a-z0-9-_.]{1,})/{0,}$', 'edit_goals'),
