...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.maintainer'
        db.alter_column('project_project', 'maintainer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Project.maintainer'
        db.alter_column('project_project', 'maintainer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'project.project': {
            ...
            'maintainer': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
