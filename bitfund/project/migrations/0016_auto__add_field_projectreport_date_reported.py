...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectReport.date_reported'
        db.add_column('project_projectreport', 'date_reported',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 2, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectReport.date_reported'
        db.delete_column('project_projectreport', 'date_reported')
