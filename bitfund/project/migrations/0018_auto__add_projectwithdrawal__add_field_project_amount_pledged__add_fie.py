...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectWithdrawal'
        db.create_table('project_projectwithdrawal', (
            ...
            ('datetime_withdrawn', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 15, 0, 0))),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('project', ['ProjectWithdrawal'])

        # Adding field 'Project.amount_pledged'
        db.add_column('project_project', 'amount_pledged',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.amount_withdrawn'
        db.add_column('project_project', 'amount_withdrawn',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.amount_redonation_given'
        db.add_column('project_project', 'amount_redonation_given',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.amount_redonation_received'
        db.add_column('project_project', 'amount_redonation_received',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.amount_balance'
        db.add_column('project_project', 'amount_balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)


        # Changing field 'Project.logo'
        db.alter_column('project_project', 'logo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting model 'ProjectWithdrawal'
        db.delete_table('project_projectwithdrawal')

        # Deleting field 'Project.amount_pledged'
        db.delete_column('project_project', 'amount_pledged')

        # Deleting field 'Project.amount_withdrawn'
        db.delete_column('project_project', 'amount_withdrawn')

        # Deleting field 'Project.amount_redonation_given'
        db.delete_column('project_project', 'amount_redonation_given')

        # Deleting field 'Project.amount_redonation_received'
        db.delete_column('project_project', 'amount_redonation_received')

        # Deleting field 'Project.amount_balance'
        db.delete_column('project_project', 'amount_balance')


        # Changing field 'Project.logo'
        db.alter_column('project_project', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
