...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectGoal.date_ending'
        db.alter_column('project_projectgoal', 'date_ending', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ProjectGoal.brief'
        db.alter_column('project_projectgoal', 'brief', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ProjectGoal.date_starting'
        db.alter_column('project_projectgoal', 'date_starting', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectGoal.date_ending'
        raise RuntimeError("Cannot reverse this migration. 'ProjectGoal.date_ending' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ProjectGoal.brief'
        raise RuntimeError("Cannot reverse this migration. 'ProjectGoal.brief' and its values cannot be restored.")

        # Changing field 'ProjectGoal.date_starting'
        db.alter_column('project_projectgoal', 'date_starting', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'project.projectneed': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 22, 0, 0)'}),
            'date_ending': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 22, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
