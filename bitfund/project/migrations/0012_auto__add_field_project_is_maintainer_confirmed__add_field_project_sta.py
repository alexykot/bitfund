...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.is_maintainer_confirmed'
        db.add_column('project_project', 'is_maintainer_confirmed',
    ...
    def backwards(self, orm):
        # Deleting field 'Project.is_maintainer_confirmed'
        db.delete_column('project_project', 'is_maintainer_confirmed')
