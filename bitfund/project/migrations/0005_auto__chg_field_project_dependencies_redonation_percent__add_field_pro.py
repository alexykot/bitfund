...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project_Dependencies.redonation_percent'
        db.alter_column('project_project_dependencies', 'redonation_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))
        # Adding field 'Project.is_refused_to_give_to_bitfund'
        db.add_column('project_project', 'is_refused_to_give_to_bitfund',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project_Dependencies.redonation_percent'
        db.alter_column('project_project_dependencies', 'redonation_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=0))
        # Deleting field 'Project.is_refused_to_give_to_bitfund'
        db.delete_column('project_project', 'is_refused_to_give_to_bitfund')
    ...
    models = {
        ...
        'project.projectneed': {
            ...
            'date_starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['project.Project']"}),
