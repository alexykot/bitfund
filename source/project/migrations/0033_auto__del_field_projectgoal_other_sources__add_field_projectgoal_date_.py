...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectGoal.other_sources'
        db.delete_column('project_projectgoal', 'other_sources')

        # Adding field 'ProjectGoal.date_starting'
        db.add_column('project_projectgoal', 'date_starting',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 25, 16, 5, 3, 4)),
                      keep_default=False)

        # Deleting field 'ProjectNeed.other_sources'
        db.delete_column('project_projectneed', 'other_sources')


    def backwards(self, orm):
        # Adding field 'ProjectGoal.other_sources'
        db.add_column('project_projectgoal', 'other_sources',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Deleting field 'ProjectGoal.date_starting'
        db.delete_column('project_projectgoal', 'date_starting')

        # Adding field 'ProjectNeed.other_sources'
        db.add_column('project_projectneed', 'other_sources',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 16, 5, 3, 4)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'project.projectgoal': {
            ...
            'date_starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 16, 5, 3, 4)'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
