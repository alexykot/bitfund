...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.regular_need'
        db.delete_column('project_project', 'regular_need')


    def backwards(self, orm):
        # Adding field 'Project.regular_need'
        db.add_column('project_project', 'regular_need',
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 19, 22, 12, 3)'}),
