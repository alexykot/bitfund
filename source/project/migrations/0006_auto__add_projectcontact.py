...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('project_projectcontact', (
            ...
            ('idependon_project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='yabadabadu', to=orm['project.Project'])),
        ))
    ...
    models = {
        ...
        'project.projectcontact': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idependon_project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'yabadabadu'", 'to': "orm['project.Project']"})
        },
        'project.projectgoal': {
