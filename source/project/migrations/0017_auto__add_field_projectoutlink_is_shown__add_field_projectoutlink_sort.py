...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectOutlink.is_shown'
        db.add_column('project_projectoutlink', 'is_shown',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectOutlink.sort_order'
        db.add_column('project_projectoutlink', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectOutlink.is_shown'
        db.delete_column('project_projectoutlink', 'is_shown')

        # Deleting field 'ProjectOutlink.sort_order'
        db.delete_column('project_projectoutlink', 'sort_order')
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 15, 8, 53, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
