...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectGoal.sort_order'
        db.add_column('project_projectgoal', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProjectNeed.sort_order'
        db.add_column('project_projectneed', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectGoal.sort_order'
        db.delete_column('project_projectgoal', 'sort_order')

        # Deleting field 'ProjectNeed.sort_order'
        db.delete_column('project_projectneed', 'sort_order')
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 17, 55, 23, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
