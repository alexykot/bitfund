...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 17, 43, 31, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'project.projectdependency': {
            'Meta': {'unique_together': "(('idependon_project', 'dependonme_project'),)", 'object_name': 'ProjectDependency'},
