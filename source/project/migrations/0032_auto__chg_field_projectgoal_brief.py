...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('project_projectgoal', 'brief', self.gf('django.db.models.fields.CharField')(default='asd', max_length=255))
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 19, 22, 41, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
