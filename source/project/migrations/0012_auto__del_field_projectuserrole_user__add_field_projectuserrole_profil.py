...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectUserRole.user'
        db.delete_column('project_projectuserrole', 'user_id')

        # Adding field 'ProjectUserRole.profile'
        db.add_column('project_projectuserrole', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['pledger.Profile']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectUserRole.user'
        raise RuntimeError("Cannot reverse this migration. 'ProjectUserRole.user' and its values cannot be restored.")
        # Deleting field 'ProjectUserRole.profile'
        db.delete_column('project_projectuserrole', 'profile_id')
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 22, 22, 4, 24, 1)'}),
