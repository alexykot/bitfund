...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectOtherSource.date_received'
        db.alter_column('project_projectothersource', 'date_received', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectOtherSource.date_received'
        raise RuntimeError("Cannot reverse this migration. 'ProjectOtherSource.date_received' and its values cannot be restored.")
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 14, 25, 30, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'project.projectcontact': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 14, 25, 31, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
