...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectRelease.is_public'
        db.add_column('project_projectrelease', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectRelease.is_public'
        db.delete_column('project_projectrelease', 'is_public')
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 16, 21, 33, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
