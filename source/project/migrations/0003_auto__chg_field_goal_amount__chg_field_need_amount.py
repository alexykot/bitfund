...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('project_goal', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=0))

        # Changing field 'Need.amount'
        db.alter_column('project_need', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=0))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Need.amount'
        db.alter_column('project_need', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=0))
    ...
    models = {
        ...
        'project.goal': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 10, 17, 36, 11, 2)'}),
