...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectOutlink.is_active'
        db.delete_column('project_projectoutlink', 'is_active')

        # Adding field 'ProjectOutlink.is_public'
        db.add_column('project_projectoutlink', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectOutlink.is_active'
        db.add_column('project_projectoutlink', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'ProjectOutlink.is_public'
        db.delete_column('project_projectoutlink', 'is_public')
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 15, 28, 39, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
