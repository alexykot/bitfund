...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectRelease.previous_version'
        db.alter_column('project_projectrelease', 'previous_version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.ProjectRelease'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectRelease.previous_version'
        raise RuntimeError("Cannot reverse this migration. 'ProjectRelease.previous_version' and its values cannot be restored.")
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 16, 7, 17, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
