...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('project_goal', 'project_projectgoal')

        db.rename_table('project_featurerequest', 'project_projectfeaturerequest')

        db.rename_table('project_need', 'project_projectneed')

    def backwards(self, orm):
        db.rename_table('project_projectgoal', 'project_goal')

        db.rename_table('project_projectfeaturerequest', 'project_featurerequest')

        db.rename_table('project_projectneed', 'project_need')
    ...
    models = {
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 12, 13, 30, 11, 4)'}),
