...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DonationCartNeeds.amount'
        db.alter_column('pledger_donationcartneeds', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        # Changing field 'DonationCartGoals.amount'
        db.alter_column('pledger_donationcartgoals', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        # Changing field 'DonationHistoryGoals.amount'
        db.alter_column('pledger_donationhistorygoals', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        # Changing field 'DonationHistoryNeeds.amount'
        db.alter_column('pledger_donationhistoryneeds', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'DonationCartNeeds.amount'
        db.alter_column('pledger_donationcartneeds', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'DonationCartGoals.amount'
        db.alter_column('pledger_donationcartgoals', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'DonationHistoryGoals.amount'
        db.alter_column('pledger_donationhistorygoals', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'DonationHistoryNeeds.amount'
        db.alter_column('pledger_donationhistoryneeds', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
    ...
    models = {
        ...
        'pledger.donationcart': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 14, 28, 41, 3)'}),
        ...
        'pledger.donationhistory': {
            ...
            'datetime_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 14, 28, 41, 3)'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 14, 28, 41, 3)'}),
