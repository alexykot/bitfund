...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DonationSubscriptionNeeds.donation_subscription'
        db.alter_column('pledger_donationsubscriptionneeds', 'donation_subscription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pledger.DonationSubscription']))

    def backwards(self, orm):

        # Changing field 'DonationSubscriptionNeeds.donation_subscription'
        db.alter_column('pledger_donationsubscriptionneeds', 'donation_subscription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pledger.DonationCart']))
    ...
    models = {
        ...
        'pledger.donationcart': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 12, 14, 39, 55, 4)'}),
        ...
        'pledger.donationhistory': {
            ...
            'datetime_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 12, 14, 39, 55, 4)'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 12, 14, 39, 55, 4)'}),
