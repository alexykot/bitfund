...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pledger_profile', 'github_profile',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.bitbucket_profile'
        db.add_column('pledger_profile', 'bitbucket_profile',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.sourceforge_profile'
        db.add_column('pledger_profile', 'sourceforge_profile',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('pledger_profile', 'github_profile')

        # Deleting field 'Profile.bitbucket_profile'
        db.delete_column('pledger_profile', 'bitbucket_profile')

        # Deleting field 'Profile.sourceforge_profile'
        db.delete_column('pledger_profile', 'sourceforge_profile')
    ...
    models = {
        ...
        'pledger.donationcart': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 22, 15, 27, 25, 1)'}),
        ...
        'pledger.donationhistory': {
            ...
            'datetime_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 22, 15, 27, 25, 1)'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 22, 15, 27, 25, 1)'}),
