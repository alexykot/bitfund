...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DonationCartNeeds.donation_type'
        db.add_column('pledger_donationcartneeds', 'donation_type',
                      self.gf('django.db.models.fields.CharField')(default='monthly', max_length=7),
                      keep_default=False)

        # Deleting field 'DonationCart.donation_type'
        db.delete_column('pledger_donationcart', 'donation_type')


    def backwards(self, orm):
        # Deleting field 'DonationCartNeeds.donation_type'
        db.delete_column('pledger_donationcartneeds', 'donation_type')

        # Adding field 'DonationCart.donation_type'
        db.add_column('pledger_donationcart', 'donation_type',
    ...
    models = {
        ...
        'pledger.donationcart': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 15, 12, 6, 18)'}),
        ...
        'pledger.donationhistory': {
            ...
            'datetime_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 15, 12, 6, 18)'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 15, 12, 6, 18)'}),
