...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Profile', fields ['token']
        db.create_unique('pledger_profile', ['token'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['token']
        db.delete_unique('pledger_profile', ['token'])
