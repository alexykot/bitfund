...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DonationHistory.email'
        db.add_column('pledger_donationhistory', 'email',
                      self.gf('django.db.models.fields.CharField')(default='asd', max_length=255),
                      keep_default=False)


        # Changing field 'DonationHistory.username'
        db.alter_column('pledger_donationhistory', 'username', self.gf('django.db.models.fields.CharField')(default='asd', max_length=30))

        # Changing field 'DonationHistory.project_title'
        db.alter_column('pledger_donationhistory', 'project_title', self.gf('django.db.models.fields.CharField')(default='asd', max_length=255))

        # Changing field 'DonationHistory.project_key'
        db.alter_column('pledger_donationhistory', 'project_key', self.gf('django.db.models.fields.CharField')(default='asd', max_length=80))

    def backwards(self, orm):
        # Deleting field 'DonationHistory.email'
        db.delete_column('pledger_donationhistory', 'email')


        # Changing field 'DonationHistory.username'
        db.alter_column('pledger_donationhistory', 'username', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'DonationHistory.project_title'
        db.alter_column('pledger_donationhistory', 'project_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DonationHistory.project_key'
        db.alter_column('pledger_donationhistory', 'project_key', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
    ...
    models = {
        ...
        'pledger.donationcart': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 14, 28, 48, 1)'}),
        ...
        'pledger.donationhistory': {
            ...
            'datetime_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 14, 28, 48, 1)'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 14, 28, 48, 1)'}),
