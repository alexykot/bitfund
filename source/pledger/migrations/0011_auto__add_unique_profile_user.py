...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('pledger_profile', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['user']
        db.delete_unique('pledger_profile', ['user_id'])
    ...
    models = {
        ...
        'pledger.donationcart': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 11, 0, 39, 19, 6)'}),
        ...
        'pledger.donationhistory': {
            ...
            'datetime_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 11, 0, 39, 19, 6)'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 11, 0, 39, 19, 6)'}),
