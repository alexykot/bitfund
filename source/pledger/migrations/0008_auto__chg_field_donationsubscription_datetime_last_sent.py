...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DonationSubscription.datetime_last_sent'
        db.alter_column('pledger_donationsubscription', 'datetime_last_sent', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DonationSubscription.datetime_last_sent'
        raise RuntimeError("Cannot reverse this migration. 'DonationSubscription.datetime_last_sent' and its values cannot be restored.")
    ...
    models = {
        ...
        'pledger.donationcart': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 17, 47, 24, 3)'}),
        ...
        'pledger.donationhistory': {
            ...
            'datetime_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 17, 47, 24, 3)'}),
        ...
        'project.project': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 17, 47, 24, 3)'}),
